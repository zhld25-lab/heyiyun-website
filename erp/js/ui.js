...
const BADGE = {
    ...
    "履约中":"bg-blue","已签订":"bg-teal","草稿":"bg-gray","已完成合同":"bg-green",
    "已批准":"bg-green","审批中":"bg-orange","已到货":"bg-green","已下单":"bg-blue","已提交":"bg-teal",
    "已同步":"bg-green","待同步":"bg-orange","未同步":"bg-gray",
    "已付款":"bg-green","部分付款":"bg-orange","未付款":"bg-red",
